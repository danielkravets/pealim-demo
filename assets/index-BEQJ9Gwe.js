...
const __vite__wasmUrl = "/pealim-demo/assets/libpealimrs_bg-DKsq0NDN.wasm";
  ...
  */
  suggest(prefix) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm$1.wordindex_suggest(retptr, this.__wbg_ptr, ptr0, len0);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var v2 = getArrayJsValueFromWasm0(r0, r1).slice();
      wasm$1.__wbindgen_free(r0, r1 * 4, 4);
...
__wbg_set_wasm(wasm);
const _withScopeId = (n) => (pushScopeId("data-v-8cdea514"), n = n(), popScopeId(), n);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    let wordIndexInstance = null;
    onMounted(async () => {
      console.log("onMounted");
      const t0 = performance.now();
      wordIndexInstance = init_local$1();
    ...
    const performSearch = async () => {
      ...
      if (doesNotStartWithHebrew(searchQuery.value)) {
        ...
        let translatedVal = await translate(searchQuery.value, "auto", "he");
        console.log("searchQuery.value translated", searchQuery.value, translatedVal);
        searchQueryValue = translatedVal;
      }
      if (searchQueryValue && searchQueryValue.length > 0 && wordIndexInstance) {
        console.log("searchQueryValue search", searchQueryValue);
        let value = wordIndexInstance.get(searchQueryValue);
        wordResults.value = value.map((e) => e.word + ": " + e.word_en);
      } else {
        wordResults.value = [];
      }
    };
    watch(searchQuery, async (newValue, oldValue) => {
      ...
      if (newValue && newValue.length > 1 && wordIndexInstance) {
        let value = wordIndexInstance.suggest(newValue);
        wordResults.value = value.map((e) => e);
      } else {
        wordResults.value = [];
      }
    }, { immediate: true });
...
const Search = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8cdea514"]]);
