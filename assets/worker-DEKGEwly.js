var __vite__wasmUrl = "/pealim-demo/assets/libpealimrs_bg-QJM3KadC.wasm";
...
class SearchResult {
    ...
    */
    ...
    /**
    * @param {WordData} word
    * @param {(MatchedForm)[]} matching_forms
    */
...
class WordData {
    ...
    * @param {string} word_normalized
    * @param {string} transcription
    * @param {string} root
    * @param {(WordForm)[]} forms
    * @param {string} binyan
    * @param {(WordForm)[] | undefined} [passive]
    * @param {string | undefined} [passive_binyan]
    */
...
class WordForm {
    ...
    * @param {string} gender
    * @param {string} form
    * @param {string} form_normalized
    * @param {string} transcription
    * @param {string} meaning
    * @param {string | undefined} [form_vowelled]
    */
...
URL = globalThis.URL;
const __vite__wasmModule = await __vite__initWasm({ "./libpealimrs_bg.js": { __wbg_searchresult_new: __wbg_searchresult_new, __wbg_worddata_new: __wbg_worddata_new, __wbg_wordform_new: __wbg_wordform_new, __wbg_matchedform_new: __wbg_matchedform_new, __wbg_wordform_unwrap: __wbg_wordform_unwrap, __wbg_worddata_unwrap: __wbg_worddata_unwrap, __wbg_matchedform_unwrap: __wbg_matchedform_unwrap, __wbindgen_throw: __wbindgen_throw } }, __vite__wasmUrl);
...
var wasm = /*#__PURE__*/Object.freeze({
    __proto__: null,
    __wbg_get_matchedform_index: __wbg_get_matchedform_index,
    __wbg_get_matchedform_kind: __wbg_get_matchedform_kind,
    __wbg_get_searchresult_matching_forms: __wbg_get_searchresult_matching_forms,
    __wbg_get_searchresult_word: __wbg_get_searchresult_word,
    __wbg_get_worddata_binyan: __wbg_get_worddata_binyan,
    __wbg_get_worddata_forms: __wbg_get_worddata_forms,
    __wbg_get_worddata_passive: __wbg_get_worddata_passive,
    __wbg_get_worddata_passive_binyan: __wbg_get_worddata_passive_binyan,
    __wbg_get_worddata_root: __wbg_get_worddata_root,
    __wbg_get_worddata_transcription: __wbg_get_worddata_transcription,
    __wbg_get_worddata_url_id: __wbg_get_worddata_url_id,
    __wbg_get_worddata_word: __wbg_get_worddata_word,
    __wbg_get_worddata_word_en: __wbg_get_worddata_word_en,
    __wbg_get_worddata_word_normalized: __wbg_get_worddata_word_normalized,
    __wbg_get_wordform_form: __wbg_get_wordform_form,
    __wbg_get_wordform_form_normalized: __wbg_get_wordform_form_normalized,
    __wbg_get_wordform_form_vowelled: __wbg_get_wordform_form_vowelled,
    __wbg_get_wordform_gender: __wbg_get_wordform_gender,
    __wbg_get_wordform_meaning: __wbg_get_wordform_meaning,
    __wbg_get_wordform_number: __wbg_get_wordform_number,
    __wbg_get_wordform_person: __wbg_get_wordform_person,
    __wbg_get_wordform_tense: __wbg_get_wordform_tense,
    __wbg_get_wordform_transcription: __wbg_get_wordform_transcription,
    __wbg_matchedform_free: __wbg_matchedform_free,
    __wbg_searchresult_free: __wbg_searchresult_free,
    __wbg_set_matchedform_index: __wbg_set_matchedform_index,
    __wbg_set_matchedform_kind: __wbg_set_matchedform_kind,
    __wbg_set_searchresult_matching_forms: __wbg_set_searchresult_matching_forms,
    __wbg_set_searchresult_word: __wbg_set_searchresult_word,
    __wbg_set_worddata_binyan: __wbg_set_worddata_binyan,
    __wbg_set_worddata_forms: __wbg_set_worddata_forms,
    __wbg_set_worddata_passive: __wbg_set_worddata_passive,
    __wbg_set_worddata_passive_binyan: __wbg_set_worddata_passive_binyan,
    __wbg_set_worddata_root: __wbg_set_worddata_root,
    __wbg_set_worddata_transcription: __wbg_set_worddata_transcription,
    __wbg_set_worddata_url_id: __wbg_set_worddata_url_id,
    __wbg_set_worddata_word: __wbg_set_worddata_word,
    __wbg_set_worddata_word_en: __wbg_set_worddata_word_en,
    __wbg_set_worddata_word_normalized: __wbg_set_worddata_word_normalized,
    __wbg_set_wordform_form: __wbg_set_wordform_form,
    __wbg_set_wordform_form_normalized: __wbg_set_wordform_form_normalized,
    __wbg_set_wordform_form_vowelled: __wbg_set_wordform_form_vowelled,
    __wbg_set_wordform_gender: __wbg_set_wordform_gender,
    __wbg_set_wordform_meaning: __wbg_set_wordform_meaning,
    __wbg_set_wordform_number: __wbg_set_wordform_number,
    __wbg_set_wordform_person: __wbg_set_wordform_person,
    __wbg_set_wordform_tense: __wbg_set_wordform_tense,
    __wbg_set_wordform_transcription: __wbg_set_wordform_transcription,
    __wbg_worddata_free: __wbg_worddata_free,
    __wbg_wordform_free: __wbg_wordform_free,
    __wbg_wordindex_free: __wbg_wordindex_free,
    ...
    matchedform_new: matchedform_new,
    memory: memory,
    searchresult_new: searchresult_new,
    worddata_new: worddata_new,
    wordform_new: wordform_new,
    wordindex_build: wordindex_build,
    wordindex_get: wordindex_get,
    wordindex_get_by_root: wordindex_get_by_root,
    wordindex_init_local: wordindex_init_local,
    wordindex_matching_forms: wordindex_matching_forms,
    wordindex_suggest: wordindex_suggest,
    wordindex_suggest_by_translation: wordindex_suggest_by_translation,
    wordindex_suggest_hebrew: wordindex_suggest_hebrew
});
  ...
  try {
    switch (method) {
      case "getWordData":
        ...
        postMessage({ id, result: wrapWithType(serializeArray(wordData), "SearchResult") });
        break;
      case "suggestWordData":
        ...
        postMessage({ id, result: wrapWithType(serializeArray(suggestedWords), "SearchResult") });
        break;
      case "matchingForms":
        const matchedForms = service.getMatchedForms(params.urlId, params.form);
        console.log("matchedForms", matchedForms.length);
        postMessage({ id, result: wrapWithType(matchedForms, "Uint32Array") });
        break;
      default:
    ...
    postMessage({ id, error: errorMessage });
  }
};
...
function serializeMatchedFormArray(forms) {
  return forms.map((form) => {
    return {
      index: form.index,
      kind: form.kind
...
function serializeSearchResult(instance) {
  return {
    ...
    matched_forms: serializeMatchedFormArray(instance.matching_forms)
  };
}
